...
class AllProductsCategoryChipWidget extends GetView<AllProductsController> {
  const AllProductsCategoryChipWidget({super.key});
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      height: 42,
      child: Obx(() {
        // Tái sử dụng logic Map mảng giống Inventory Insight
