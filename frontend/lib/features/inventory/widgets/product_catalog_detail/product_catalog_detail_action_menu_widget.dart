...
class ProductCatalogDetailActionMenuWidget
    extends GetView<ProductCatalogDetailController> {
  const ProductCatalogDetailActionMenuWidget({super.key});

  @override
  Widget build(BuildContext context) {
    // Chỉ Manager/Owner mới thấy nút 3 chấm này
    if (!controller.canManageProduct) return const SizedBox.shrink();
...
class _GlassmorphismDropdownMenuState extends State<_GlassmorphismDropdownMenu>
  ...
  Widget _buildGlassmorphismCard() {
    final controller = Get.find<ProductCatalogDetailController>();
          ...
          child: Column(
            ...
            children: [
              ...
              _buildMenuItem(
                ...
                text: TTexts.deleteProduct.tr, // ĐÃ SỬA
