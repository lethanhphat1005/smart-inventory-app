...
import 'package:frontend/features/transaction/widgets/inbound_product_selection/inbound_product_selection_bottom_bar_widget.dart';
import 'package:frontend/features/transaction/widgets/inbound_product_selection/inbound_product_selection_cart_bottom_sheet_widget.dart';
...
class InboundProductSelectionMobileView
    extends GetView<InboundProductSelectionController> {
  const InboundProductSelectionMobileView({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      child: Scaffold(
                  ...
                  sliver: SliverList(
                    delegate: SliverChildBuilderDelegate(
                      (context, index) {
                        ...
                        // Bọc từng item bằng Obx để nó nhảy số lập tức khi bấm +/-
                        return Obx(() {
        ...
        bottomNavigationBar: Obx(() => InboundProductSelectionBottomBarWidget(
              totalItems: controller.totalDraftItems,
              totalPrice: controller.totalDraftPrice,
              onCartTap: () => Get.bottomSheet(
                  const InboundProductSelectionCartBottomSheetWidget(),
